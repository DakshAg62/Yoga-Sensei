...
reference_image = cv2.imread('d:\One Drive\OneDrive\Pictures\Camera Roll\WIN_20231218_17_09_57_Pro.jpg')
...
keypoint_labels = {
    ...
    "HandsNotAtRightPosition": "Hands not at the right position",
    "HandsNotAbove": "Raise your hands over your head",  # elbow and eye
...
@app.route('/')
def index():
    return render_template('vrik_advance.html')
